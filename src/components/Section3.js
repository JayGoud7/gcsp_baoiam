...
const Section3 = () => {
  ...
  return (
    <section className="w-full h-full xs:w-full xs:h-full">
        ...
        {section2.map((info, index) => {
          ...
          return (
            ...
            >
              ...
              <div className="flex flex-col gap-4 opacity-0 group-hover:opacity-100 absolute top-0 left-0 right-0 bottom-0 z-10 bg-black/50 transition-all ease-linear text-center pt-24 text-white xs:pt-16">
